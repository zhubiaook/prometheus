...
grammar coming from [Prometheus](https://github.com/zhubiaook/prometheus/blob/main/promql/parser/generated_parser.y)
written in yacc.

This library is stable but doesn't provide any guideline of how to use it as it has been integrated
into [codemirror-promql](https://github.com/zhubiaook/prometheus/blob/main/web/ui/module/codemirror-promql). If you
want to use this library, you perhaps want to actually use **@prometheus-io/codemirror-promql** instead.

**Note**: This library is a lezer-based implementation of the [authoritative, goyacc-based PromQL grammar](https://github.com/zhubiaook/prometheus/blob/main/promql/parser/generated_parser.y). 
...
The code is licensed under an [Apache 2.0](https://github.com/zhubiaook/prometheus/blob/main/LICENSE) license.

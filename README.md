...
[![Go Report Card](https://goreportcard.com/badge/github.com/zhubiaook/prometheus)](https://goreportcard.com/report/github.com/zhubiaook/prometheus)
[![CII Best Practices](https://bestpractices.coreinfrastructure.org/projects/486/badge)](https://bestpractices.coreinfrastructure.org/projects/486)
[![Gitpod ready-to-code](https://img.shields.io/badge/Gitpod-ready--to--code-blue?logo=gitpod)](https://gitpod.io/#https://github.com/zhubiaook/prometheus)
...
```bash
git clone https://github.com/zhubiaook/prometheus.git
cd prometheus
```
...
```bash
GO111MODULE=on go install github.com/zhubiaook/prometheus/cmd/...
...
An example of the above configuration file can be found [here.](https://github.com/zhubiaook/prometheus/blob/main/documentation/examples/prometheus.yml)
...
```shell
go get github.com/zhubiaook/prometheus@v0.35.0
```
...
* Godoc documentation is available via [pkg.go.dev](https://pkg.go.dev/github.com/zhubiaook/prometheus). Due to peculiarities of Go Modules, v2.x.y will be displayed as v0.x.y.
* You will find a CircleCI configuration in [`.circleci/config.yml`](.circleci/config.yml).
* See the [Community page](https://prometheus.io/community) for how to reach the Prometheus developers and users on various communication channels.

## Contributing

Refer to [CONTRIBUTING.md](https://github.com/zhubiaook/prometheus/blob/main/CONTRIBUTING.md)

## License

Apache License 2.0, see [LICENSE](https://github.com/zhubiaook/prometheus/blob/main/LICENSE).

...
For details on the request and response messages, see the [remote storage protocol buffer definitions](https://github.com/zhubiaook/prometheus/blob/main/prompb/remote.proto).

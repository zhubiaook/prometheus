...
Usage:
* [`stripeSeries`](https://github.com/zhubiaook/prometheus/blob/fdbc40a9efcc8197a94f23f0e479b0b56e52d424/tsdb/head.go#L1292-L1298) (note: when you don't know a `HeadSeriesRef` for a series, you can also access it by a hash of the series' labels)
* WAL
...
* [`HeadChunkID`](https://pkg.go.dev/github.com/zhubiaook/prometheus/tsdb/chunks#HeadChunkID) references a chunk of a `memSeries` (either an `mmappedChunk` or `headChunk`).
...
* [`ChunkDiskMapperRef`](https://pkg.go.dev/github.com/zhubiaook/prometheus/tsdb/chunks#ChunkDiskMapperRef) is an 8 Byte integer.
